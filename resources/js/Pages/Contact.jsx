...
export default function Contact() {
    ...
    return (
        <>
            <Seo
                title="Contact Us"
                description="Get in touch with Mahadeva Swamigal Children Home (MSCH) to learn about our programs, volunteer opportunities, or how you can support our mission."
            />
